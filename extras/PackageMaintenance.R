...
OhdsiRTools::checkUsagePackage("SevereCovidPrediction")
OhdsiRTools::updateCopyrightYearFolder()

# Create manual -----------------------------------------------------------
shell("rm extras/SevereCovidPrediction.pdf")
shell("R CMD Rd2pdf ./ --output=extras/SevereCovidPrediction.pdf")
...
OhdsiRTools::insertEnvironmentSnapshotInPackage("SevereCovidPrediction")
